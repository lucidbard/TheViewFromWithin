...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error
{
    ...
    [_data appendBytes:&_radius length:sizeof(short)];
...
//    
//    //GaussianBlur(image, image, Size2i(9,9), 2,2);
//    vector<Vec3f> circles;
//    HoughCircles(image, circles, CV_HOUGH_GRADIENT, 1, 100, 180, 90, 25, 120);
...
//        
//        /*
//         // Debug tracking circles
//         NSLog(@"%f, %f", circles[i][0], circles[i][1]);
//         NSLog(@"%d", radius);
